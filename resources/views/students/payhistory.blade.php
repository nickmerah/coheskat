					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">Payment History</a>&nbsp;
								</li>
							</ol>
						</div>
					</div>
										...
										<table
											...
											<tbody>
                                                ...
                                                <tr class="odd gradeX">
													...
													<td class="center"><a href="{{URL::to('/paymentreceipt/'.$transdata->trans_no) }}" target="_blank">{{ $transdata->trans_no  }}</a></td>
...
@endphp</td>
													...
													<td class="center"><a href="{{URL::to('/paymentreceipt/'.$transdata->trans_no) }}" target="_blank"><span
															class="label label-lg label-success">paid</span></a></td>
